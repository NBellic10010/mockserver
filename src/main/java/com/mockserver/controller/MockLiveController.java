...
public class MockLiveController {
    ...
    static {
        ...
        Situations_running.put("66187", "{" +
                ...
                "    \"Result\":" +
                "        {" +
                "            \"sgf\":\"(;GM[1]FF[4]CA[UTF-8]SO[弈客围棋]RU[cn]KM[7.5]HA[0]AP[弈客围棋]SZ[19]PB[W[陆敏全])\"," +
                "            \"result\":\"\"," +
                "            \"status\":2," +
                "            \"id\":66113," +
                "            \"delete_flag\":0" +
